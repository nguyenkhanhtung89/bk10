...
#define BUTTON_LED_GPIO_CLK						RCC_AHBPeriph_GPIOC
#define BUTTON_STATUS 								(!GPIO_ReadInputDataBit(BUTTON_LED_GPIO_PORT, BUTTON_LED_GPIO_PIN))
...
extern uint8_t Mode_disable_OBD;
