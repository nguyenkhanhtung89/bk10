...
#define USE_RELEASE_BUTTON  				((uint32_t)0x0803E000)

#define OBD_TYPE_ADDR  							((uint32_t)0x0803D800)

#define DEV_CONFIG_ADDR  						((uint32_t)0x0803D000)

#define BUZZER_LEVEL_ADDR  					((uint32_t)0x0803C000)

#define TYPE_FULSE_ADC_ADDR  				((uint32_t)0x0803B800)

#define ADD_VIN_NUMBER  						((uint32_t)0x0803B000)

//#define DEV_CONFIG_ADDR  						((uint32_t)0x0803C800)
