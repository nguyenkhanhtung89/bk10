...
#define LED_GPS_GPIO_CLK					  	RCU_GPIOB
...
#define LED_DRIVER_GPIO_CLK					  RCU_GPIOB

#define BUZZER_GPIO_PIN								GPIO_PIN_8
#define BUZZER_GPIO_PORT 							GPIOC
#define BUZZER_GPIO_CLK					  		RCU_GPIOC

#define ACC_GPIO_PIN									GPIO_PIN_6
#define ACC_GPIO_PORT 								GPIOB
#define ACC_GPIO_CLK					  			RCU_GPIOB
#define ACC_STATUS 										(!gpio_input_bit_get(ACC_GPIO_PORT, ACC_GPIO_PIN))

#define DOOR_GPIO_PIN									GPIO_PIN_14
#define DOOR_GPIO_PORT 								GPIOC
#define DOOR_GPIO_CLK					 				RCU_GPIOC
#define DOOR_STATUS 									GetStatusDoor()

#define AIR_GPIO_PIN									GPIO_PIN_13
#define AIR_GPIO_PORT 					  		GPIOC
#define AIR_GPIO_CLK					    		RCU_GPIOC
#define AIR_STATUS 										GetStatusAir()

#define BUTTON_LED_GPIO_PIN						GPIO_PIN_2//ok
#define BUTTON_LED_GPIO_PORT 					GPIOC
#define BUTTON_LED_GPIO_CLK						RCU_GPIOC
#define BUTTON_STATUS 								(!gpio_input_bit_get(BUTTON_LED_GPIO_PORT, BUTTON_LED_GPIO_PIN))
