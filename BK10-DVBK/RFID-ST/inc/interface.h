...
#define LED_POWER_GPIO_CLK					  RCC_AHBPeriph_GPIOC

#define LED_GPS_GPIO_PIN							GPIO_Pin_1
#define LED_GPS_GPIO_PORT 						GPIOC
#define LED_GPS_GPIO_CLK					  	RCC_AHBPeriph_GPIOC
...
#define LED_DRIVER_GPIO_CLK					  RCC_AHBPeriph_GPIOC
...
#define NC_MCU_GPIO_CLK					  		RCC_AHBPeriph_GPIOC
