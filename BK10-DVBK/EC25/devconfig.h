...
typedef struct{
	...
	u8 allow_reset_cam;
	char upload_db_url[MAX_SIZE_URL + 1];
	u8 Decrease_Speed;
	u8 DisableWLXTN;
	u8 DisableWLXTT;
	u8 DisableWCAM;
	u8 DisableWRFID;
	u8 flg_clear_data_new_ver;
}device_setting_typedef;

typedef struct{//khong duoc them bot truong du lieu
	u64 DeviceID;
	...
	float MotionValue;
}sys_setting;//SIZE SETTING 376byte
...
#define CURRENT_WEEK_PATH       "/usr/data/CurrentWeek.dat"
...
#define DECREASE_SPEED_PATH     "/usr/data/DecreaseSpeed.dat"
#define FLG_CLEAR_NEW_VER_PATH  "/usr/data/FLGClearNewVer.dat"

#define DISABLE_WLXTN_PATH	    "/usr/data/DisableWLXTN.dat"
#define DISABLE_WLXTT_PATH      "/usr/data/DisableWLXTT.dat"
#define DISABLE_WCAM_PATH       "/usr/data/DisableWCAM.dat"
#define DISABLE_WRFID_PATH      "/usr/data/DisableWRFID.dat"

#define UPLOAD_DB_URL_PATH      "/usr/data/UploadDbUrl.dat"
...
#define TIME_SEND_PICTURE_PATH  "/usr/data/TimeSendPicture.dat"

#define COUNT_WARNING_CAM_PATH  "/usr/data/CountWarningCMR.dat"
